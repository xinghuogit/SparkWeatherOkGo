 ...
 */
public class Urls {
    public static final String SERVER = "https://www.wanandroid.com/";
...
//    public static final String URL_GANK_BASE = "http://gank.io/api/data/";
    ...
    //    public static final String URL_GANK_BASE = "http://gank.io/api/data/";
    public static final String URL_GET_WXARTICLE_CHAPTERS_JSON = "wxarticle/chapters/json"; //get 获取公众号列表


    public static final String URL_POST_LG_TODO_ADD_JSON = "lg/todo/add/json"; //post  新增一条Todo
}
